...
import Logo from "./../../img/footer/selo-dponet-300x92-1.png";
    ...
    <Box as="footer" bg="Blue.800">
      ...
      >
        <GridItem mb={{ base: "20px", sm: "0px" }}>
          <Text as="h6" letterSpacing="2px" fontSize="20px" color="white">
            CONTATO
          </Text>
          <Stack spacing={1} fontSize="14px">
            <Text mt="2" fontWeight="light" color="white">
              contato@simcompany.com.br
            </Text>
        ...
        <GridItem mb={{ base: "20px", sm: "0px" }}>
          ...
          <Stack spacing={2} color="white" fontSize="14px">
            <MenuItem link="/produtos/comunicacao/goto-connect">
              GoTo Connect
            </MenuItem>
            <MenuItem link="/produtos/comunicacao/goto-room">
              GoTo Room
            </MenuItem>
            <MenuItem link="/produtos/comunicacao/goto-contact-center">
              GoTo Contact Center
            </MenuItem>
            <MenuItem link="/produtos/comunicacao/goto-meeting">
              GoTo Meeting
            </MenuItem>
            <MenuItem link="/produtos/comunicacao/goto-webinar">
              GoTo Webinar
            </MenuItem>
            <MenuItem link="/produtos/comunicacao/novas-possibilidades-com-goto">
        ...
        <GridItem mb={{ base: "20px", sm: "0px" }}>
          ...
          <Stack spacing={2} color="white" fontSize="14px">
            <MenuItem link="/produtos/senhas/lastpass-business">
              LastPass Empresarial
            </MenuItem>
            <MenuItem link="/produtos/senhas/lastpass-pessoal">
              LastPass Pessoal
            </MenuItem>
          </Stack>
        </GridItem>
        ...
        <GridItem mb={{ base: "20px", sm: "0px" }}>
          ...
          <Stack spacing={2} color="white" fontSize="14px">
            ...
            <MenuItem link="/produtos/acesso-remoto/goto-my-pc">
              GoTo My Pc
            </MenuItem>
            <MenuItem link="/produtos/acesso-remoto/pro">Pro</MenuItem>
            <MenuItem link="/produtos/acesso-remoto/goto-resolve">
              GoTo Resolve
            </MenuItem>
      ...
      >
        <Text>
          Desenvolvido por Isaques Estúdios | Todos os Direitos Reservados a Sim
          Company®
        </Text>
