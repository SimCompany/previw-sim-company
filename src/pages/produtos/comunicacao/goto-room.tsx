...
export default function Comunicação() {
  return (
    <>
      <Head>
        <title>
          Reunioes Empresariais com GoTo Meeting | Tenha reuniões mais
          proficionais na empresa
        </title>
        <meta
          name="description"
          content="Adquira sua plataforma de reuniões online, com qualidade de áudio e vídeo, melhore a qualidade de comunicação da sua empresa"
        />
      </Head>
      ...
      <main style={{ maxWidth: "1920px", margin: "0 auto" }}>
        ...
        >
          <GridItem>
            ...
            <Text color="White">
              O GoTo Room oferece equipamentos de videoconferência intuitivos e
              econômicos que ajudam a descomplicar as reuniões.
            </Text>
        ...
        <DoubleGrid
          ...
          urlImage={Meeting}
        >
          <H3 color="Blue.800" mb="4">
            O GoTo Room funciona em qualquer lugar, do home office ás salas de
            reunião e dadiretoria à empresa
          </H3>
          <Topics
        ...
        >
          <H3 color="Blue.800" mb="4">
            Aumente a produtividade com recursos práticos
          </H3>
          <Topics
