...
import First from "./../../../img/atendimento/central-atendimento.jpg";
...
export default function Comunicação() {
  return (
    <>
      <Head>
        <title>
          Software para central de atendimento | central de atendimento em nuvem
          melhor experiência para clientes
        </title>
        <meta
          name="description"
          content="Software para central de atendimento em nuvem, receba informações e avaliações dos clientes e muito mais"
        />
      </Head>
      ...
      <main style={{ maxWidth: "1920px", margin: "0 auto" }}>
        ...
        >
          <GridItem>
            ...
            >
              Central de atendimento empresarial em nuvem
            </H1>
            <Text color="white">
              Atendimentos de qualidade, comunique-se com seus clientes com
              maior qualidade, call center em nuvem para pequenas e médias
              empresas.
            </Text>
            <Link href="#contact">
              <ButtonChakra mt="4" px="10" py="7">
        ...
        <Track bgColor="Green.300" title="Central de atendimento em nuvem" />
        ...
        <Flex flexDirection="column" alignItems="center">
          <H3 textAlign={{ base: "center" }}>
            Solicite um orçamento com a Sim Company
          </H3>
          <Link href="#contact">
            <ButtonChakra px="40px" py="26px" mt="2">
              Fazer um orçamento
            </ButtonChakra>
          </Link>
        </Flex>
        ...
        >
          ...
          <TabPanels>
            <TabPanel>
              ...
              <Text>
                Tome decisões de negócios fundamentadas com{" "}
                <Text as="b">relatórios e análises em tempo real</Text>
              </Text>

              <Text>
                Oriente os agentes e melhore as interações com os{" "}
                <Text as="b">modos Ouvinte e Sussurro</Text>, além da{" "}
                <Text as="b">gravação de chamadas</Text>
              </Text>

              <Text>
                Reduza os tempos de espera com as{" "}
                <Text as="b">filas de retorno de chamadas</Text>
              </Text>

              <Text>
                Melhore a resolução de problemas em chamadas com o{" "}
                <Text as="b">encaminhamento de chamadas inteligente</Text>
              </Text>
            </TabPanel>
            ...
            <TabPanel>
              ...
              <Text>
                Reduza o tempo ocioso e aumente o tempo ativo de atendimento com{" "}
                <Text as="b">correios de voz pré-gravados</Text>
              </Text>

              <Text>
                Melhore a produtividade e acelere as chamadas de vendas com o{" "}
                <Text as="b">discador automático</Text>
              </Text>

              <Text>
                Alterne tranquilamente entre{" "}
                <Text as="b">voz, vídeo, bate-papo e SMS</Text>, de acordo com a
                preferência do cliente{" "}
              </Text>

              <Text>
                Confira o desempenho e os KPIs com{" "}
                <Text as="b">painéis de agentes</Text> personalizáveis{" "}
              </Text>
            </TabPanel>
            ...
            <TabPanel>
              ...
              <Text>
                Configure fluxos de chamadas facilmente com um{" "}
                <Text as="b">editor visual de planos de discagem</Text> de
                arrastar e soltar{" "}
              </Text>

              <Text>
                <Text as="b">Integre seu CRM</Text> facilmente para obter
                informações e insights atualizados sobre o cliente{" "}
              </Text>

              <Text>
                Alivie a carga dos administradores de TI{" "}
                <Text as="b">atribuindo permissões</Text> a outros membros da
                equipe
              </Text>

              <Text>
                Ajuste a <Text as="b">configuração multicanal</Text> para voz,
                vídeo, bate-papo e SMS
              </Text>
            </TabPanel>
          </TabPanels>
        </Tabs>
        ...
        >
          ...
          >
            ...
            <H3>R$ 193.00</H3>
            <Text mt={{ base: "10px", md: "25px" }}>
              Os recursos essenciais: resposta de voz interativa, filas,
              bate-papo pela Web, integração com o Facebook e relatórios padrão.
            </Text>

            <Text mt="10" as="b">
              {" "}
              /usuário por mês, cobrança anual
            </Text>
            <ButtonForm plane="core">Solicitar orçamento</ButtonForm>
          </GridItem>
          ...
          >
            ...
            <H3>R$ 308.00</H3>
            <Text mt={{ base: "10px", md: "25px" }}>
              Todos os recursos do Core, além de relatórios avançados e
              funcionalidades de gerenciamento.
            </Text>

            <Text mt="10" as="b">
              {" "}
              /usuário/mês, cobrança anual
            </Text>
            <ButtonForm plane="completo">Solicitar orçamento</ButtonForm>
          </GridItem>
        </Grid>
      </main>
    </>
