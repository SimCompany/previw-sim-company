...
export default function PlataformaVideoconferencia() {
  return (
    <>
      <Head>
        <title>
          Comunicação de alto nivel por assinatura com GoTo Meeting | Vídeo em
          HD e àudio nítido
        </title>
        <meta name="description" content="Comunicação para grandes empresas, com qualidade de áudio e vídeo, com segurança e rapidez" />
      </Head>
      ...
      <main style={{ maxWidth: "1920px", margin: "0 auto" }}>
        ...
        >
          <GridItem>
            <H1
              lineHeight={{ base: "48px", sm: "52px", lg: "58px" }}
              mb="20px"
              fontSize={{ base: "40px", sm: "45px", lg: "50px" }}
              color="White"
              fontWeight="extrabold"
            >
              reuniões online simplificado com a segurança das grandes empresas
            </H1>
            <Text color="White">
              Software de reuniões online simplificado com a segurança das
              grandes empresas, liberdade e praticidade.
            </Text>
            <ButtonForm mt="4">Solicitar orçamento</ButtonForm>
          </GridItem>
          <GridItem></GridItem>
        </Grid>
        ...
        <Flex flexDirection="column" alignItems="center">
          ...
          <ButtonForm maxW="30%">Solicitar orçamento</ButtonForm>
        </Flex>
