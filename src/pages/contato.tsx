    ...
    <Box position="relative">
      ...
      >
        <Box mr={{ base: "0px", md: "4" }} flex="0.5">
          ...
          <Text color="white">
            <Text as="b">Telefone:</Text> 0800 591 4571
          </Text>
          <Text color="white">
            <Text as="b">Email:</Text> contato@simcompany.com
          </Text>
          <Text color="white">
            <Text as="b">Endereço:</Text> Rua Dr. Soares Hungria 772 - Centro
            Cerquilho - SP
          </Text>
